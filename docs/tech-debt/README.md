...
| [TD-2026-09-03](TD-2026-09-03.md) | Codecov upload has never authenticated | Dependabot first-wave triage (codecov-action bump, PR #37) | Next edit to ci.yml's coverage job, the next major `codecov-action` bump, or the next release | open |
...
| [TD-2026-09-05](TD-2026-09-05.md) | rust-cache is pinned to a branch head under a release comment | Dependabot first-wave triage (SHA pin check, PR #37); carries TD-2026-07-07's addendum | The next github-actions Dependabot PR that moves the rust-cache pin, or the first `rustsec/audit-check` release after v2.0.0 | open |
